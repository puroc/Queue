...
public class LowConsumer {
	public static void main(String args[]) {
		LowConsumer example = new LowConsumer();
		long maxReads = GlobalConfig.DATA_NUM;
		String topic = GlobalConfig.TOPIC_NAME;
		int partition = 0;
		List<String> seeds = new ArrayList<String>();
		seeds.add(GlobalConfig.KAFKA_HOST);
		int port = Integer.parseInt(GlobalConfig.KAFKA_PORT);
		try {
	...
	public void run(long a_maxReads, String a_topic, int a_partition,
		...
		//
		long linkLoadBeginTime = System.currentTimeMillis();
		...
		System.out.println(GlobalConfig.DATA_NUM + " use time ms=" + (System.currentTimeMillis() - linkLoadBeginTime));
		if (consumer != null)
			consumer.close();
	}
